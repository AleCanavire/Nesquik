...
function MiniTitleDetail() {
  ...
  useEffect(()=>{
    ...
    document.addEventListener("mousemove", handleOnHideModal);
    ...
    <div className="mini-modal-container">
      <div className="mini-title-detail" style={{...positionDetail, ...showMiniStyles}} ref={miniModalRef} aria-modal={true} role="dialog">
        <div className="mini-detail-media">
          ...
          <div style={showTrailer ? {opacity: "0", visibility: "hidden"} : {}} className="title-backdrop-container">
            <img
              className="title-backdrop"
              src={`https://image.tmdb.org/t/p/w780${miniModal.backdrop.file_path}`}
            />
            { (!miniModal?.backdrop?.iso_639_1 && miniModal?.logo?.file_path) &&
              <img
                className="title-logo"
                src={`https://image.tmdb.org/t/p/w185${miniModal.logo.file_path}`}
              />
        ...
        <div className="mini-detail-info" style={showMiniModal ? {opacity: "1"} : {opacity: "0"}}>
          <div className="metadata-and-controls">
            <div className="button-controls">
              ...
              <button className="more-info button-control" onClick={handleOnAddInfo}>
                ...
                <div className="more-info-tooltip">Episodios e info</div>
              </button>
            </div>
...
export default MiniTitleDetail