...
function Header() {
  ...
  }, [randomTitle, title, window.innerWidth])
  ...
  function hideHeaderOverview(e) {
    const currentTime = Math.trunc(e.playedSeconds);
    const hideTrailer = trailerDuration.current - 15;
    currentTime === 5 && setShowTrailer(true);
    ...
    <header className="header-title">
      <div className="header-media">
        <ReactPlayer
          ...
          muted={isMuted}
          playing={isPlaying}
          onProgress={hideHeaderOverview}
          onDuration={e => trailerDuration.current = e}
          onEnded={() => {setIsPlaying(false); console.log("hola")}}
        />
        {title &&
          <img
