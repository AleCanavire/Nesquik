...
function MiniTitleDetail() {
  ...
  return (
    <div className="mini-modal-container">
      <div style={positionDetail} className="mini-title-detail" onMouseLeave={() => {hideModal(); setShowTrailer(false)}}>
        <div className="mini-detail-media">
          ...
          <div className="title-logo-and-toggle">
            <img
              ...
              src={`https://image.tmdb.org/t/p/w185${miniModal.logo}`}
            />
          ...
          <img
            style={showTrailer ? {opacity: "0", visibility: "hidden"} : {}}
        ...
        <div style={showMiniModal ? {opacity: "1"} : {opacity: "0"}} className="mini-detail-info">
          <div className="metadata-and-controls">
            <div className="button-controls">
              ...
              <button className="more-info button-control" onClick={()=> setInfoTitle(miniModal)}>
